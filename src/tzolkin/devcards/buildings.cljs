...
(deftest buildings
  (testing
    (nod (logic/gain-building s 0 {:cost {:corn 2 :wood 1}})
         (-> s
    ...
    (nod (logic/gain-building s 0 {:materials {:wood 2}})
         (-> s
           (update-in [:players 0 :buildings] conj {:materials {:wood 2}})
           (update-in [:players 0 :materials :wood] + 2)))
    (nod (logic/gain-building s 0 {:temples {:kuku 2 :chac 1}})
         (-> s
    ...
    (nod (logic/gain-building s 0 {:tech :any-two})
         (-> s
           ...
           (update-in [:active :decisions] conj {:type :tech
                                                 :options [{:agri 1} {:extr 1} {:arch 1} {:theo 1}]})))
    (nod (logic/gain-building s 0 {:build :building})
