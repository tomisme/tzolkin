...
(deftest buildings
  (testing
    (is (= (logic/gain-building s 0 {:cost {:corn 2 :wood 1}})
           (-> s
    ...
    (is (= (logic/gain-building s 0 {:materials {:wood 2}})
           (-> s
             (update-in [:players 0 :buildings] conj {:materials {:wood 2}})
             (update-in [:players 0 :materials :wood] + 2))))
    (is (= (logic/gain-building s 0 {:temples {:kuku 2 :chac 1}})
           (-> s
    ...
    (is (= (logic/gain-building s 0 {:build :monument})
           (-> s
